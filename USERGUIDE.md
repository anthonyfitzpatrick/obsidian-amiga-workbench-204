...
3. Create `themes/Modern Amiga Workbench 2.04 inspired/` inside `.obsidian` if it does not already exist. **The folder name
...
Check the folder is `.obsidian/themes/Modern Amiga Workbench 2.04 inspired/` and contains both `theme.css` and
...
remove it from disk, delete `.obsidian/themes/Modern Amiga Workbench 2.04 inspired/`.

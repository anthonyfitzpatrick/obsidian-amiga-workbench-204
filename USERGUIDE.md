...
3. Create `themes/Amiga Workbench 2.04/` inside `.obsidian` if it does not already exist. **The folder name
...
Check the folder is `.obsidian/themes/Amiga Workbench 2.04/` and contains both `theme.css` and
...
remove it from disk, delete `.obsidian/themes/Amiga Workbench 2.04/`.
